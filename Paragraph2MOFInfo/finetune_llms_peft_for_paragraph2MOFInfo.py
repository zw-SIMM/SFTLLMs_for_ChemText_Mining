...
train_file = "data/data_for_llms/train_329.csv"
...
# Model Version
model_name = "/home/zhangwei/pretrained_models/llama-2-13b-chat-hf"              # Path of the pretrained model downloaded from Hugging Face (llama-2-13b-chat-hf or Mistral-7B-Instruct-v0.2)
new_model_dir = f"saved_models/llama2_13b_chat_qlora/train_{len(train_df)}_lora_r{lora_r}_lr{learning_rate}"  # Fine-tuned model name
