...
train_df = pd.read_csv("data/prod/train.csv")
...
new_model_dir = f"saved_models/Meta-Llama-3-8B-Instruct/train_{len(train_df)}_lr{learning_rate}_bs{per_device_train_batch_size}"  # Fine-tuned model name
