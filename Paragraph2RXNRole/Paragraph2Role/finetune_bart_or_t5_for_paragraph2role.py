...
class CFG:
    ...
    # Data Configuration
    train_file = "data/role/train.csv"
    test_file = "data/role/test.csv"
    source_text_column = "input"
...
class CustomCallback(TrainerCallback):    
    ...
    def on_epoch_end(self, args, state, control, **kwargs):
            ...
            if epoch % CFG.interval_eval_epoch == 0 :
                ...
                ground_label = [i['bio_label'] for i in self._trainer.eval_dataset]
                ...
                predicted_df['BIO Label'] = ground_label
